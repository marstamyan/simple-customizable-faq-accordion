...
function mk_faq_options_page() {
	add_menu_page( __( 'FAQ Options', MK_FAQ_TEXT_DOMAIN ), __( 'FAQ Options', MK_FAQ_TEXT_DOMAIN ), 'manage_options', 'mk-faq-options', 'mk_faq_options_page_html' );
}
...
function mk_faq_options_page_html() {
    ...
    <div class="wrap">
        <div class="mk-faq-instruction">
            ...
            <a href="https://github.com/marstamyan/simple-customizable-faq-accordion" class="mk-faq-link">Link</a>
        </div>
    </div>
	<?php
}